...
export class registroNotas { 
    ...
    constructor(_nomeEstudante: string,
        ...
        _notaBim1: number,
        _notaBim2: number) {
            this._nomeEstudante = _nomeEstudante
            this._matriculaEstudante=_matriculaEstudante
            this._notaBim1=_notaBim1
            this._notaBim2=_notaBim2
    }
    ...
    public calcularMediaFinal(notaAvaliacaoFinal?: number) {
        ...
        if (notaAvaliacaoFinal === undefined) {return undefined}
